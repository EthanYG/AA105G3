...
<%
    ...
    List<Product_order_listVO> list = product_order_listSvc.getProduct_order_list_By_One_PK(prod_ord_no);
...
<c:forEach var="product_order_listVO" items="${product_order_listSvc.getProduct_order_list_By_One_PK(param.prod_ord_no)}">
